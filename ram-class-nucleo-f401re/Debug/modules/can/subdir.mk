...
modules/can/%.o modules/can/%.su modules/can/%.cyclo: ../modules/can/%.c modules/can/subdir.mk
...
clean: clean-modules-2f-can

clean-modules-2f-can:
	-$(RM) ./modules/can/can.cyclo ./modules/can/can.d ./modules/can/can.o ./modules/can/can.su

.PHONY: clean-modules-2f-can
