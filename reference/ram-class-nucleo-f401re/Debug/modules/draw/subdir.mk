...
modules/draw/%.o modules/draw/%.su modules/draw/%.cyclo: ../modules/draw/%.c modules/draw/subdir.mk
...
clean: clean-modules-2f-draw

clean-modules-2f-draw:
	-$(RM) ./modules/draw/draw.cyclo ./modules/draw/draw.d ./modules/draw/draw.o ./modules/draw/draw.su

.PHONY: clean-modules-2f-draw
