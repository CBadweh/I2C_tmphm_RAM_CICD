...
modules/step/%.o modules/step/%.su modules/step/%.cyclo: ../modules/step/%.c modules/step/subdir.mk
...
clean: clean-modules-2f-step

clean-modules-2f-step:
	-$(RM) ./modules/step/step.cyclo ./modules/step/step.d ./modules/step/step.o ./modules/step/step.su

.PHONY: clean-modules-2f-step
